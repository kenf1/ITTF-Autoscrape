...
def sidebar():
    ...
    sl.sidebar.markdown('A copy of the dataset can be downloaded from: \n \n <a href="https://github.com/kenf1/ITTF-Autoscrape/tree/main/data"><img src="https://logosmarcas.net/wp-content/uploads/2020/12/GitHub-Simbolo.png" height="38" /></a> <a href="https://mega.nz/folder/cIwFQKbI#F4BzQEww3yQSMUj5THSZjw"><img src="http://icons.iconarchive.com/icons/papirus-team/papirus-apps/512/mega-icon.png" height="38" /></a> <a href="https://www.kaggle.com/datasets/bmarcg/all-ittf-rankings"><img src="https://cdn.icon-icons.com/icons2/2699/PNG/512/kaggle_logo_icon_168474.png" height="38" /></a>',unsafe_allow_html=True)
